...
export default function HomePage() {
    ...
    const loadCartStatus = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const addedBooks = new Set(cartItems.map((item: { bookId: string }) => item.bookId));
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Welcome Section */}
      <section className="text-center bg-red-500 p-8 rounded-lg mb-12 shadow-md">
        <h1 className="text-4xl font-extrabold text-white mb-2">Welcome to the Amana Bookstore!</h1>
